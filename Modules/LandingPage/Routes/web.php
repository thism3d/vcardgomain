...
Route::get('directory/share/{slug}', [MarketplaceController::class, 'share'])->name('bussiness.share');
Route::get('directory/card-view/{slug}', [MarketplaceController::class, 'cardView'])->name('bussiness.view');
Route::get('directory/contact-view/{id}', [MarketplaceController::class, 'contactData'])->name('bussiness.contact');
