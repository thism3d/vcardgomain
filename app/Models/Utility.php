...
class Utility extends Model
{
    ...
    public static function themeOne()
    {
        ...
        $arr = [
            ...
            'theme22' => [
                'color1-theme22' => [
                    'img_path' => asset(Storage::url('uploads/card_theme/theme22/color1.png')),
                    'color' => '#FF6F61',
                    'theme_name' => 'theme22-v1'
                ],
                'color2-theme22' => [
                    'img_path' => asset(Storage::url('uploads/card_theme/theme22/color2.png')),
                    'color' => '#6B5B95',
                    'theme_name' => 'theme22-v2'
                ],
            ],
