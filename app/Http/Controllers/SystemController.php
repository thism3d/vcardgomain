...
class SystemController extends Controller
{
    ...
    public function adminPaymentSettings($request)
    {
        ...
        if (isset($request->is_authorizenet_enabled) && $request->is_authorizenet_enabled == 'on') {
            $request->validate(
                [
                    ...
                    'authorizenet_client_id' => 'required|string',
                    'authorizenet_merchant_key' => 'required|string',
                ]
            );
            ...
            $post['authorizenet_merchant_key'] = $request->authorizenet_merchant_key;
        } else {
        ...
        if (isset($request->is_easybuzz_enabled) && $request->is_easybuzz_enabled == 'on') {
            ...
            $post['is_easybuzz_enabled'] = $request->is_easybuzz_enabled;
    ...
    public function recaptchaSettingStore(Request $request)
    {
        ...
        $arrEnv = [
            ...
            'RECAPTCHA_VERSION' => $request->google_recaptcha_version,
