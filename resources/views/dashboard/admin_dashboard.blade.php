                        ...
                        <div class="col-xl-2 col-md-4 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-body" style="min-height: 230px;">
                                    ...
                                    <h6 class="mb-0 mt-2">{{ __('PAID USERS : ') }} <span
                                            class="text-success text-sm ">{{ $user['total_paid_user'] }}</span></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-md-4 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-body" style="min-height: 230px;">
                                    ...
                                    <h6 class="mb-0 mt-2">{{ __('Total Order Amount : ') }} <span
                                            class="text-warning text-sm ">{{ (isset($admin_payment_setting['CURRENCY_SYMBOL']) ? $admin_payment_setting['CURRENCY_SYMBOL']  : '$') . $user['total_orders_price'] }}</span>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-2 col-md-4 col-sm-6 col-12 ">
                            <div class="card">
                                <div class="card-body" style="min-height: 230px;">
                                    ...
                                    <h6 class="mb-0 mt-2">{{ __('Most Purchase Plan : ') }}<span
                                            class="text-primary text-sm ">{{ $user['most_purchese_plan'] }}</span></h6>
                                </div>
                            </div>
                        </div>
