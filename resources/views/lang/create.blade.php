...
<div class="row">
    <div class="form-group col-md-12">
        ...
        {{ Form::text('code', '', array('class' => 'form-control','required'=>'required','placeholder'=>'Enter Language Code')) }}
        @error('code')
    ...
    <div class="form-group col-md-12">
        ...
        {{ Form::text('fullName', '', array('class' => 'form-control','required'=>'required','placeholder'=>'Enter Language Name')) }}
        @error('fullName')
        <span class="invalid-code" role="alert">
            <strong class="text-danger">{{ $message }}</strong>
        </span>
